...
from nets.vgg import vggsnn_cifar, vggsnn_dvs, vgg11, vgg13
from nets.resnet import resnet18
# from nets.ucir_cifar_resnet import resnet32 as cosine_resnet32
# from nets.ucir_resnet import resnet18 as cosine_resnet18
# from nets.ucir_resnet import resnet34 as cosine_resnet34
# from nets.ucir_resnet import resnet50 as cosine_resnet50
# from nets.linears import SimpleLinear, SplitCosineLinear, CosineLinear
# from nets.modified_represnet import resnet18_rep,resnet34_rep
# from nets.resnet_cbam import resnet18_cbam,resnet34_cbam,resnet50_cbam
# from nets.memo_resnet import  get_resnet18_imagenet as get_memo_resnet18 #for MEMO imagenet
# from nets.memo_cifar_resnet import get_resnet32_a2fc as get_memo_resnet32 #for MEMO cifar
# from nets.ACL_buffer import RandomBuffer, activation_t
# from nets.linears import RecursiveLinear
...
def get_convnet(args, pretrained=False):
    ...
    kwargs_spikes = {'kwargs_spikes' : {'v_reset': args["v_reset"], 'thresh': args["thresh"], 'decay': warp_decay(args["decay"]),
                    'detach_reset': args["detach_reset"], "rate_flag": args["rate_flag"]}, 'step_mode' : args["step_mode"], 'T' : args["T"], 'model_name' : args["model_name"]}
    
    if args["dataset"] == "urbansoundswap" or args["dataset"] == "dsadsswap":
        inchannel = 1
    elif args["dataset"] == "ncaltech101swap" or args["dataset"] == "dvs128swap":
        inchannel = 2
    else:
        inchannel = 3
    model = eval(name + f'(in_channel={inchannel}, num_classes={args["init_cls"]}, **kwargs_spikes)')
    return model
    # elif name == "resnet34":
...
class DmmIncrementalNet(BaseNet):
    def __init__(self, args, pretrained, gradcam=False):
        super().__init__(args, pretrained)
        self.gradcam = gradcam
        if hasattr(self, "gradcam") and self.gradcam:
